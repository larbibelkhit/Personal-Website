    ...
    <section className="flex min-h-screen bg-blue-highlight text-white flex-1 " id='about'>
        <div className="m-auto max-container padding-container mt-30 flex flex-col-reverse md:flex-row p-5">
            <div className='top-20 sm:sticky md:top-28 lg:top-32 md:w-1/2'>
                ...
                <p className='text-lg mt-5'>I am currently an Industy Analyst at ABI Research, leading the 5G, 6G & Open RAN research team. I recently graduated with Bachelor of Science with Honours in Computer Science from Queen Mary, University of London.</p>
                <p className='text-lg mt-5'>When I am not working, I enjoy building websites from scratch, learning about new technologies, playing chess, going to the gym and cooking new food from various cuisines.</p>
